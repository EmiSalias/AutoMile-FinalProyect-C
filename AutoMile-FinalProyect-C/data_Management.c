...
//void guardarFechaActual()/// esta funcion se utilizaria para poder guardar en variables globales la fecha actual tomada desde la computadora, para luego contrastar a la hora de realizar alquileres
//{
//    const char *cadenaTiempo;
//    // Obtener la cadena de tiempo actual
//    time_t tiempo_actual = time(NULL);
//    cadenaTiempo = ctime(&tiempo_actual);
//
...
//    global_dia = fecha_hora_actual.dia;
//    global_mes = fecha_hora_actual.mes;
//    global_anio = fecha_hora_actual.anio;
//}
...
int verificarFechas(Fecha fechaInicio, Fecha fechaFin)
{
...
Alquiler ingresoAlquilerUsuario(Patente patente, float precioPorDia, int dni, Fecha fechaInicio, Fecha fechaFin)
{
    Alquiler nuevoAlquiler;
    nuevoAlquiler.patenteVehi = patente;
    nuevoAlquiler.fechaInicio = fechaInicio;
    nuevoAlquiler.fechaFin = fechaFin;
